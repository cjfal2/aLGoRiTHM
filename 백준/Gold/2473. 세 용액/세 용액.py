...
def mixing(x):
    ...
    acidic: +쪽 용액의 포인터 산성
    '''
    pH, basic, acidic = sys.maxsize, liquid.index(x)+1, N - 1
    while (basic < acidic): # 염기성이 산성보다 커지면 종료
        mix = x + liquid[basic] + liquid[acidic] # 염기성과 산성을 섞어봄
        ...
        if mix < 0: # mix가 0보다 작으면 염기성 포인터를 옮겨봄
            ...
            acidic -= 1
    return pH, x, neutral_small, neutral_large
